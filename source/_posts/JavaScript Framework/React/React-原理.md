...
![](React-原理.assets/image-20230220134458551.png)

虚拟 DOM 本质上是一个 JS 对象，而真实 DOM 则是一个 dom 结构。  
![](React-原理.assets/image-20230220134532418.png)

在真实 DOM 上默认挂载了许多属性和方法，所以虚拟 DOM 相比真实 DOM 在结构方面轻便的多。
...
![](React-原理.assets/image-20230220134558080.png)
...
**节点位置改变，进行移动**  
![](React-原理.assets/image-20230220134609671.png)
...
**缺陷：**  
![](React-原理.assets/image-20230220134624937.png)
...
![](React-原理.assets/image-20230220135629142.png)
